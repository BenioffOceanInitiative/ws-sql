...
librarian::shelf(
  ...
  mapview, purrr, sf, stringr, tibble)
...
```{r, results='asis'}
dir_shp   <- "/Volumes/GoogleDrive/.shortcut-targets-by-id/1SHlPwuO32zevQ6W9ZHb-CQLigiXRFeDY/AIS Ship Report Cards/Data/WhaleSafeUSA_Shapefiles"
