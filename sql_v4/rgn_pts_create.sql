...
ALTER TABLE `{tbl_rgn_pts}`
  ...
  ALTER COLUMN `mmsi` SET OPTIONS (description = "GFW: source specific vessel id. This is the transponder id, and for AIS this is the MMSI. Converted to INT64 by WhaleSafe."),
