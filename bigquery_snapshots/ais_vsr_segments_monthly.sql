...
SET snapshot_name = CONCAT("whalesafe_v3_backup.ais_vsr_segments_monthly_", 
    FORMAT_DATETIME("%Y%m%d", @run_date)); SET query = CONCAT("CREATE SNAPSHOT TABLE ", 
    snapshot_name, "CLONE benioff-ocean-initiative.whalesafe_v3.ais_vsr_segments 
